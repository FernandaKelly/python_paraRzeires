...
```{python}
(df.assign(
    lucro =  df.receita - df.orcamento,
    #lambda x: x.receita-x.orcamento,
 ...
 filter(["receita","orcamento", "lucro", "categoria_lucrou"]))
```

```{python}
frequency_table = df["receita"].value_counts(dropna=False)
